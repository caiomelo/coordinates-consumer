...
public class Haversine {
    ...
    public static double distanceInMeters(PlannedStop plannedStop, VehicleCoordinates coordinates2) {
        double latitudeDelta = Math.toRadians(plannedStop.getLatitude() - coordinates2.getLatitude());
        double longitudeDelta = Math.toRadians(plannedStop.getLongitude() - coordinates2.getLongitude());

        double latitudePointOne = Math.toRadians(plannedStop.getLatitude());
        double latitudePointTwo = Math.toRadians(coordinates2.getLatitude());
